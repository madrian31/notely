    ...
    <View style={[styles.container, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={styles.header}>
        <Pressable onPress={() => router.back()} style={styles.backBtn}>
          <Text style={[styles.backText, { color: journalColor }]}>‹</Text>
        </Pressable>
        <Text style={styles.headerTitle} numberOfLines={1}>{journalName}</Text>
        <Pressable
          onPress={() => goToNoteForm()}
          style={styles.addBtn}
          hitSlop={{ top: 20, bottom: 20, left: 20, right: 20 }}
        >
          <Text style={[styles.addText, { color: journalColor }]}>＋</Text>
        </Pressable>
      </View>
        ...
        renderItem={({ item: month }) => (
          <View>
            ...
            {groupedNotes[month].map(noteItem => (
              ...
              >
                <View style={[styles.noteAccent, { backgroundColor: journalColor }]} />
                ...
                <Pressable
                  onPress={() => { setSelectedNote(noteItem); setMenuVisible(true); }}
...
emptyState: {
  ...
  emptyText: { color: '#fff', fontSize: 17, fontWeight: '600', marginBottom: 4 },
  ...
  noteTitle: { color: '#f0f0f0', fontSize: 15, fontWeight: '600', marginBottom: 3 },
